...
class AutomatoVariaveisInt {
    ...
    public function estado5() {
        ...
        $this->tabelaSimbolos($this->cadeia, "Identificador", "Variavel", "Int");
        if ($this->simbolo == "=") {
            $this->tabelaSimbolos($this->simbolo, "Operador", "Atibuição");
            $this->estadoAtual = 6;
    ...
    public function estado7() {
        ...
        $this->tabelaSimbolos($this->cadeia, "Numero", "Numerico", "Int");
        if ($this->simbolo == ",") {
            $this->tabelaSimbolos($this->simbolo, "Separador", "Simbolo para separação");
            $this->estadoAtual = 0;
        } else if ($this->simbolo == ";") {
